          ...
          <div>
            ...
            <div className="flex gap-2">
              <button
                ...
                className={`flex-1 rounded-lg border px-3 py-2 text-xs ${visibility === 'private' ? 'border-emerald-600 bg-emerald-50 text-emerald-700 dark:border-emerald-700 dark:bg-emerald-950/40 dark:text-emerald-300' : 'border-border bg-background text-muted-foreground'}`}
              >
                🔒 Riêng tư
              </button>
              <button
                ...
                className={`flex-1 rounded-lg border px-3 py-2 text-xs ${visibility === 'shared' ? 'border-emerald-600 bg-emerald-50 text-emerald-700 dark:border-emerald-700 dark:bg-emerald-950/40 dark:text-emerald-300' : 'border-border bg-background text-muted-foreground'}`}
              >
                👥 Cả nhà thấy
              </button>
            </div>
