...
export class ParserSubagent {
  ...
  private async buildContext(
    ...
    return [
      ...
      ...recentLines,
      '',
      '> ⚠️ CHỈ dùng id từ list trên cho update_transaction / delete_transaction khi message HIỆN TẠI có cue đính chính rõ ràng ("không phải", "à không", "nhầm", "ý tôi là", "huỷ", "xoá"). Xem section 7.b.',
      '> Message độc lập (kể cả trùng nội dung txn cũ) → log_transaction MỚI.',
      '',
      '### Khoản nợ đang mở',
      ...debtLines,
      '',
