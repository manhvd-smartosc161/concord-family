...
- **Quỹ mục tiêu** (Du lịch, Đầu tư, …): nếu sau này em tạo Quỹ mục tiêu (xem mục tiếp theo), chúng cũng sẽ hiện ở đây để em nhập số tiền đã save sẵn (vd đã để dành 5tr cho quỹ Du lịch trước khi xài Concord).
...
> 💡 Sau khi tạo Quỹ mục tiêu, em có thể quay lại **⚙️ Cài đặt → Số dư khởi điểm** — list quỹ giờ sẽ có row cho từng envelope vừa tạo. Nhập tiền đã save sẵn cho quỹ đó (nếu có) ở đây, đừng tạo "giao dịch chuyển vào" qua chat (sẽ bị coi là chi phí của tháng).
